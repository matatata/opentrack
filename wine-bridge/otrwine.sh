        ...
        do
            ...
            then
                ...
                then
                    ...
                    echo_stderr "$dir/$fname links to unexpected $real"
                    return 1
                fi
            elif [ -f "$dir/$fname" ]
            then
...
find_existing_links_print0() {
    ...
    find "$1"  \( -name "freetrackclient.dll" -o -name "npclient.dll" -o \
                  -name "freetrackclient64.dll" -o -name "npclient64.dll" -o \
                  -name "freetrackclient.so" -o -name "npclient.so" -o \
                  -name "freetrackclient64.so" -o -name "npclient64.so" \
                \)  -type l -print0
}
...
do_list() {
    ...
    find "$dir"  \( \
                    -name "freetrackclient.dll" -o -name "npclient.dll" \
